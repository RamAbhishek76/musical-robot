...
class G_data(object):
    ...
    def sep_data(self, seed=0):
        #TODO : separate for node classification
...
class FileLoader(object):
    ...
    def process_g(self, label_dict, tag2index, tagset, g):
        ...
        from run_GNN import Print
        # Print(g.feas.shape, g.feas.sum())
        
        Print('This create one hot, which you should change, Im SERIOUS')
    ...
    def load_data(self):
        ...
        with open('data_Unet/%s/%s.txt' % (args.data, args.data), 'r') as f:
            lines = f.readlines()
